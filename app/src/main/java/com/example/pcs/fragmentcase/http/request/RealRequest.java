...
import com.example.pcs.fragmentcase.http.CommonParams;
import com.example.pcs.fragmentcase.http.HandlerMain;
import com.example.pcs.fragmentcase.http.HttpManager;
import com.example.pcs.fragmentcase.http.callback.CommonCallback;
import com.example.pcs.fragmentcase.http.error.ErrorModel;
import com.example.pcs.fragmentcase.http.error.Errors;
import com.example.pcs.fragmentcase.http.error.NetworkException;
